...
<div class="container_12">
    ...
    <div class="grid_4" style="background-color: white">
        <form action="insert.php" method="POST" >
            From:
            <input type="text" name="cfrom"><br><br>
            To   :
            <input type="text" name="cto"><br><br>
            AC Cost:
            <input type="text" name="accost"><br><br>
            Non AC cost: <input type="text" name="noncost"><br><br>
            Plane Cost: <input type="text" name="aircost"><br><br>
